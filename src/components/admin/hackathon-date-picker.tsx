    ...
    <div className="rounded-xl border border-outline bg-surface-low/60 p-6 backdrop-blur-md">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${selected
                    ? "bg-secondary text-white shadow-[0_0_12px_rgba(255,77,41,0.4)]"
                    : today
                      ? "ring-1 ring-secondary/50 text-on-surface hover:bg-surface-high"
      ...
      <div className="flex gap-3">
        <button
          onClick={handleSave}
          disabled={isPending}
          className="flex-1 rounded-lg bg-gradient-to-r from-secondary to-primary py-3 font-space-grotesk text-xs font-bold uppercase tracking-wider text-white transition-all hover:shadow-[0_0_20px_rgba(255,77,41,0.3)] disabled:opacity-50"
        >
